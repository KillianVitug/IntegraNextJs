...
import type { CustomPayrollResultsType } from "@/lib/queries/getEmployeeSearchResults";
...
type Props = {
  data: CustomPayrollResultsType;
};

type RowType = CustomPayrollResultsType[0];

export default function PayrollCodeTable({ data }: Props) {
