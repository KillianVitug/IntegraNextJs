...
import { InsertCustomPayrollSchemaType, CustomPayrollPayload } from "@/zod-schemas/payrollCodeCustom";
...
export async function createCustomPayrollCode(payload: CustomPayrollPayload) {
    return db.transaction(async (tx) => {
      ...
      for (const [type, data] of Object.entries(payload.contributions) as [string, ContributionData][]) {
